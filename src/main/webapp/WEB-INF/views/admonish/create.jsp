...
<html>
<head>
    <title><s:message code="pages.create-admonish.title"/></title>
</head>
<body>
<spring:form modelAttribute="createAdmonishForm">
    <div>
        <label><s:message code="pages.create-admonish.form.title"/>: <spring:input path="title"/><spring:errors path="title" element="span"/></label>
    </div>
    <div>
        <label><s:message code="pages.create-admonish.form.pages"/>: <spring:input path="pages" type="number" min="0" max="1000"
